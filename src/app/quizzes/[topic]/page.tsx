...
import { addXP, XP_REWARDS, checkAndUnlockAchievements, ACHIEVEMENTS, getMotivationalMessage, getLevelInfo, getXP } from '@/lib/gamification';
...
export default function TopicQuizPage() {
  ...
  const totalMarks = perQuestion.reduce((s, p) => s + p.marks, 0);
